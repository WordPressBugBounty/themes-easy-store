...
class Easy_Store_Slider extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
    	...
    	$easy_store_slider_cat_menu   = ! empty( $instance['is_category_menu'] ) ? $instance['is_category_menu'] : null;
    	...
    	$easy_store_slider_post_count = ! empty( $instance['section_post_count'] ) ? $instance['section_post_count'] : 3;
