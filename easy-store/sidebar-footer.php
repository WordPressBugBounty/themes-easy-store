...
$footer_widget_option = easy_store_get_customizer_option_value( 'easy_store_footer_widget_option' );

if ( false === $footer_widget_option ) {
    return;
}
...
$easy_store_footer_widget_column = easy_store_get_customizer_option_value( 'easy_store_footer_widget_column' );
?>
